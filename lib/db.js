...
-- Beta feedback — intentionally simple (no status/triage workflow yet).
-- Works for logged-in and logged-out submitters alike.
CREATE TABLE IF NOT EXISTS feedback (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  user_id INTEGER,           -- NULL if submitted while logged out
  email TEXT,                -- self-reported, used for logged-out submitters
